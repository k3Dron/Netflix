    ...
    >
      <div className="px-4 md:px-8 lg:px-16 py-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center">
          <svg viewBox="0 0 111 30" className="h-6 md:h-8 fill-red-600" aria-hidden="true" focusable="false">
            <g>
        ...
        <div className="flex items-center space-x-4">
          <button onClick={() => router.push("/?query=")} className="text-white hover:text-white/80">
